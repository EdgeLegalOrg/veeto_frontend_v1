...
import { formatDateTimeFunc } from "pages/Edge/utils/utilFunc";
    ...
    <React.Fragment>
      ...
      >
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger text-white">
              {unreadCount}
          ...
          <SimpleBar style={{ maxHeight: "300px" }} className="pe-2">
            {notifications.length === 0 && (
              <div className="text-center p-4">
                ...
                <p className="mb-0 fs-13 text-muted">You are all caught up.</p>
              </div>
            )}
                    ...
                    <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                      {notification.targetDate && (
                        <span>
                          ...
                          {formatDateTimeFunc(notification.targetDate)}
                        </span>
                      )}
                    </p>
                  </div>
