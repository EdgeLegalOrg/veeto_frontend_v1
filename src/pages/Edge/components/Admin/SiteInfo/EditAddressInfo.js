...
import { editAddressInfo } from "../../../apis";
...
const EditAddressInfo = (props) => {
  ...
  const [tempSearchField, setTempSearchField] = useState(selectedAddress);
  ...
  useEffect(() => {
    ...
    setTempSearchField(selectedAddress);
  ...
  const handleSubmitEditForm = async () => {
    ...
    try {
      const { data } = await editAddressInfo(formData);
      if (data.success) {
        setShowEdit(false);
        refresh();
        setTimeout(() => {
        ...
        <div className="row">
          ...
          <div className="col-md-4 mt-3">
            <SearchableAddressDropDown
              ...
              // required={
              //   requiredFields.indexOf('city'.toLowerCase()) >= 0 ? true : false
              // }
          ...
          <div className="col-md-4 mt-3">
            <SearchableState
              ...
              // required={requiredFields.indexOf('state') >= 0 ? true : false}
          ...
          <div className="col-md-4 mt-3">
            <SearchableCountry
              ...
              handleSelectCountryAndState={handleChangeCountryAndState}
              // required={requiredFields.indexOf('country') >= 0 ? true : false}
