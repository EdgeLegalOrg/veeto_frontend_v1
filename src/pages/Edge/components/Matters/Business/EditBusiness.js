...
const EditBusiness = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    if (invalid) {
      ...
      try {
        const { data } = await editBusiness(d);
        if (data.success) {
          if (props.refresh) {
            props.refresh();
            setTimeout(() => {
        ...
        <div className="row mt-3">
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("lengthOfContract")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("otherDateForCompletion")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("finalDateOfNoticeToComplete")}
        ...
        <div className="row mt-3">
          <div className="col-md-3">
            <SelectInputField
              ...
              invalid={isRequired("conveyancingType")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("auctionDate")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("registeredBusinessName")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("registrationNo")}
        ...
        <div className="row mt-3">
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("telephoneNo")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("emailAddress")}
        ...
        <div className="row mt-3">
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("businessType")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("trainingPeriodBefore")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("trainingPeriodAfter")}
        ...
        <div className="row mt-3">
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("purchasePrice")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("gstComponent")}
        ...
        <div className="row mt-3">
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("otherConsideration")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("depositType")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("depositBondExpiry")}
        ...
        <div className="row mt-3">
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("warrantyAmount")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("warrantyPeriodFrom")}
        ...
        <div className="row mt-3">
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("warrantyPeriodTo")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("businessKnownAs")}
          ...
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("plantFittings")}
        ...
        <div className="row mt-3">
          <div className="col-md-3">
            <TextInputField
              ...
              invalid={isRequired("stockInTrade")}
