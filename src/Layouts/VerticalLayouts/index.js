 ...
 */
  ...
  const onResetRouterState = (event, pathname) => {
    if (props.formStatus.isFormChanged) {
      dispatch(
        updateFormStatusAction({
          key: "isShowModal",
          value: true,
          callback: () => {
            dispatch(resetCurrentRouterState(true));
              ...
              {item["isHeader"] ? (
                                ...
                                {!subItem.isChildItem ? (
                                  <li className="nav-item">
                                    <Link
                                      ...
                                      className="nav-link"
                                      onClick={(event) => {
                                        onResetRouterState(event, subItem.link);
                                      }}
                                    >
                ...
                <li className="nav-item">
                  <Link
                    ...
                    onClick={(event) => {
                      // item.click(event);
                      onResetRouterState(event, item.link);
                    }}
                  >
                    <i className={item.icon}></i>{" "}
